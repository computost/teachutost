...
public class WeatherForecastService(IHubContext<WeatherForecastHub, IWeatherForecastClient> hubContext)
    : BackgroundService
{
    public static IReadOnlyCollection<string> Summaries { get; } =
